    ...
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs font-headline font-bold tracking-widest text-[#ababab] uppercase">Performance Goals</span>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="bg-[#262626]/40 backdrop-blur-xl p-5 rounded-2xl flex items-center justify-between border border-white/5">
            <div className="flex flex-col">
              <span className="text-xs font-semibold text-[#ababab] uppercase tracking-wider mb-1">Daily Amount</span>
              <div className="flex items-baseline gap-1">
                <span className="text-2xl font-headline font-extrabold text-[#00fdc1]">{state.settings.dailyGoal}</span>
            ...
            <div className="flex items-center gap-2">
              <button 
                ...
                className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-white active:scale-90 transition-transform"
              >
          ...
          <div className="bg-[#262626]/40 backdrop-blur-xl p-5 rounded-2xl flex items-center justify-between border border-white/5">
            <div className="flex flex-col">
              <span className="text-xs font-semibold text-[#ababab] uppercase tracking-wider mb-1">Portion Size</span>
              <div className="flex items-baseline gap-1">
                <span className="text-2xl font-headline font-extrabold text-[#7f98ff]">{state.settings.portionSize}</span>
                <span className="text-[#ababab] text-sm">grams</span>
              </div>
            </div>
            <div className="flex items-center gap-2">
      ...
      <section className="space-y-4">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs font-headline font-bold tracking-widest text-[#ababab] uppercase">Smart Calibration</span>
        </div>
        <div className="bg-[#131313] p-6 rounded-2xl border border-white/5 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-[#ababab] text-sm mb-6 leading-relaxed">
              Our algorithm utilizes a precision ratio based on your mass and goals to optimize ATP regeneration.
            </p>
            <button 
              onClick={() => setIsCalibrating(true)}
              className="w-full bg-gradient-to-r from-[#00edb4] to-[#aaffdc] text-[#004734] py-4 rounded-full font-headline font-extrabold text-sm uppercase tracking-widest shadow-lg shadow-[#00fdc1]/10 active:scale-95 transition-all"
            >
              Launch Calculator
            </button>
          </div>
      ...
      <section className="space-y-4">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs font-headline font-bold tracking-widest text-[#ababab] uppercase">System</span>
        </div>
          ...
          <div className="p-5 bg-[#131313] rounded-2xl border border-white/5 space-y-4">
            <div className="flex justify-between items-center">
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-[#666666] uppercase tracking-wider">Current: {state.settings.resetTime || "04:30"}</span>
              </div>
              <span className="text-xl font-headline font-black text-[#00fdc1]">{state.settings.resetTime || "04:30"}</span>
            </div>
            <input 
              type="range" 
              min="0" 
          ...
          <div className="fixed inset-0 z-[60] flex items-end justify-center px-4 pb-10 bg-black/80 backdrop-blur-sm">
            ...
            >
              <div className="flex justify-between items-center mb-8">
                ...
                <button onClick={() => setIsCalibrating(false)} className="text-[#ababab] hover:text-white">
                  <X className="w-6 h-6" />
                </button>
              </div>
              ...
              <div className="space-y-8">
                <div className="space-y-2">
                  <label className="text-xs font-headline font-bold tracking-widest text-[#ababab] uppercase">Current Weight Calibration</label>
                  <div className="flex items-center justify-between border-b border-[#00fdc1]/30 py-4">
                    <div className="flex items-center gap-4">
                      <span className="text-5xl font-headline font-black text-[#00fdc1] w-24">{weight}</span>
                      <span className="text-xl font-headline font-bold text-[#ababab]">kg</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <button 
                        onClick={() => setWeight(prev => Math.max(20, prev - 1))}
                        className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white active:scale-90 transition-transform bg-[#131313]/50"
                      >
                ...
                <div className="space-y-4">
                  <label className="text-xs font-headline font-bold tracking-widest text-[#ababab] uppercase">Performance Level</label>
                  <div className="grid grid-cols-2 gap-3">
                    <button 
                      onClick={() => setPerfGoal('gym')}
                      className={cn(
                        "rounded-xl p-4 text-left transition-all border",
                        perfGoal === 'gym' ? "bg-[#00fdc1]/20 border-[#00fdc1]/40 ring-2 ring-[#00fdc1]" : "bg-[#262626]/40 border-white/5 grayscale opacity-70"
                      )}
                    >
                      <span className={cn("block font-bold mb-1", perfGoal === 'gym' ? "text-[#00fdc1]" : "text-white")}>Gym</span>
                      <span className="text-[10px] text-[#ababab] leading-tight">Standard maintenance (0.1g/kg, max 10g).</span>
                    </button>
                    <button 
                      onClick={() => setPerfGoal('gym_more')}
                      className={cn(
                        "rounded-xl p-4 text-left transition-all border",
                        perfGoal === 'gym_more' ? "bg-[#00fdc1]/20 border-[#00fdc1]/40 ring-2 ring-[#00fdc1]" : "bg-[#262626]/40 border-white/5 grayscale opacity-70"
                      )}
                    >
                      <span className={cn("block font-bold mb-1", perfGoal === 'gym_more' ? "text-[#00fdc1]" : "text-white")}>Gym & More</span>
                      <span className="text-[10px] text-[#ababab] leading-tight">High intensity (0.2g/kg, max 22g).</span>
                    </button>
                  </div>
                </div>
                ...
                <div className="pt-4">
                  <div className="flex justify-between items-center mb-6 px-2">
                    ...
                    <span className="text-2xl font-headline font-extrabold text-[#00fdc1]">{recommendedDose}g</span>
                  </div>
                  <button 
