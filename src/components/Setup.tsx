...
export default function Setup({ onComplete }: SetupProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-12 max-w-md mx-auto">
      <header className="fixed top-0 w-full z-50 flex items-center justify-between px-6 h-16 bg-gradient-to-b from-[#0e0e0e] to-transparent">
      </header>
      ...
      >
        <div className="space-y-4">
          <label className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#ababab]">Body Weight</label>
          ...
          <div className="grid grid-cols-2 gap-2">
            <button 
              ...
              className={cn(
                ...
                perfGoal === 'gym' ? "bg-[#00fdc1]/20 border-[#00fdc1]/40 ring-1 ring-[#00fdc1]" : "bg-[#262626]/40 border-white/5 opacity-50"
              )}
            >
              <span className={cn("block font-bold mb-0.5", perfGoal === 'gym' ? "text-[#00fdc1]" : "text-white")}>Gym</span>
            ...
            <button 
              ...
              className={cn(
                "rounded-xl p-3 text-left transition-all border text-xs",
                perfGoal === 'gym_more' ? "bg-[#00fdc1]/20 border-[#00fdc1]/40 ring-1 ring-[#00fdc1]" : "bg-[#262626]/40 border-white/5 opacity-50"
              )}
            >
              <span className={cn("block font-bold mb-0.5", perfGoal === 'gym_more' ? "text-[#00fdc1]" : "text-white")}>Gym & More</span>
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-end">
            <label className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#ababab]">Daily Goal</label>
            <span className="text-[#00fdc1] font-headline font-extrabold text-3xl tracking-tighter">
              {dailyGoal}<span className="text-sm font-normal text-[#ababab] ml-1">g</span>
            </span>
          </div>
          <input 
            type="range" 
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-end">
            <label className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#ababab]">Portion Size</label>
            <span className="text-[#7f98ff] font-headline font-extrabold text-3xl tracking-tighter">
              {portionSize}<span className="text-sm font-normal text-[#ababab] ml-1">g</span>
            </span>
          </div>
          <input 
            type="range" 
